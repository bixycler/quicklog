...
function json_encode_utf8($obj){ return json_encode($obj, JSON_UNESCAPED_UNICODE); }
...
class logapi extends RESTful {
  ...
  protected $logs = null;
    ...
    if(false){//DEBUG
      // check on phpMyAdmin: SHOW VARIABLES LIKE '%character_set%'; SHOW VARIABLES LIKE '%collation%'; 
    ...
    // so we must manually set charset for this connection! (for real_escape_string() to work properly)
